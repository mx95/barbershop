          ...
          >
            ...
            <Card className="glass-card">
              <CardContent className="p-6">
                <p className="mb-4 text-xs tracking-wider text-gold uppercase">Opening Hours</p>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
            <Card className="glass-card">
              <CardContent className="p-8">
                <h2 className="font-heading mb-6 text-2xl">Send a Message</h2>
