...
const fallbackPosts = [
  ...
  { id: "5", caption: "Classic cut", media_url: "https://images.unsplash.com/photo-1621605815971-fbc98d665033?w=400&q=80", permalink: instagramProfile, timestamp: new Date().toISOString() },
];
